...
variable "hana_cluster_vip" {
  description = "Virtual ip for the hana cluster. If not provided the ip well be autogenerated based in the vnet address range"
  type        = string
  default     = ""
}
...
variable "drbd_cluster_vip" {
  description = "Virtual ip for the drbd cluster. If not provided the ip well be autogenerated based in the vnet address range"
  type        = string
  default     = ""
}
