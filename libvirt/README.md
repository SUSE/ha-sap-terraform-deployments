...
- **hana_platform_folder**: path relative to hana_inst_media, where already extracted HANA platform installation media exists. This media will have preference over hdbserver sar archive installation media.
- **hana_sapcar_exe**: path to the sapcar executable, relative to hana_inst_media.
- **hdbserver_sar**: path to the HANA database server installation sar archive, relative to hana_inst_media.
